        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 hover:bg-[var(--primary)] hover:text-white transition-colors" aria-label="Instagram">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 hover:bg-[var(--primary)] hover:text-white transition-colors" aria-label="Facebook">
